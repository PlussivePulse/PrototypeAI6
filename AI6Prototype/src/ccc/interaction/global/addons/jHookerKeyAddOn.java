...
public class jHookerKeyAddOn implements NativeKeyListener {
		 ...
		 * @throws IOException
		 */
		public jHookerKeyAddOn() throws IOException {
		...
		public static void main(String arguments[]) throws IOException, NativeHookException {
			...
			GlobalScreen.addNativeKeyListener(new jHookerKeyAddOn());
		}
	}